...
//     AxiosWrapper.get(`/api/v1/hotels/${slug}`)
//     .then( (resp) => {
...
//     const hotel_id = parseInt(hotel.data.id)
//     AxiosWrapper.post('/api/v1/reviews', { ...review, hotel_id })
//     .then( (resp) => {
...
//           <Column>
//             <ReviewForm
//               name={hotel.data.attributes.name}
//               review={review}
